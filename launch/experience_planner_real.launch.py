...
def generate_launch_description():
    ...
    enable_path_tracking = LaunchConfiguration("enable_path_tracking")
    tracking_odom_topic = LaunchConfiguration("tracking_odom_topic")
    tracking_cmd_vel_topic = LaunchConfiguration("tracking_cmd_vel_topic")
    enable_local_obstacle_cloud = LaunchConfiguration("enable_local_obstacle_cloud")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "real_params_file",
                default_value=PathJoinSubstitution(
                    [package_share, "config", "experience_planner_real.yaml"]
                ),
            ),
            DeclareLaunchArgument("use_clicked_point_router", default_value="true"),
            DeclareLaunchArgument("use_rviz", default_value="true"),
            DeclareLaunchArgument("enable_path_tracking", default_value="true"),
            DeclareLaunchArgument("tracking_odom_topic", default_value="/odom"),
            DeclareLaunchArgument("tracking_cmd_vel_topic", default_value="/tgw_experience/cmd_vel"),
            DeclareLaunchArgument("enable_local_obstacle_cloud", default_value="false"),
            DeclareLaunchArgument(
                "local_obstacle_cloud_topic", default_value="/tgw_experience/local_cloud"
            ),
            DeclareLaunchArgument(
                "rviz_config",
                default_value=PathJoinSubstitution(
            ...
            Node(
                ...
                parameters=[
                    ...
                    real_params_file,
                    {
                        ...
                        "tracking_odom_topic": tracking_odom_topic,
                        "tracking_cmd_vel_topic": tracking_cmd_vel_topic,
                        "enable_local_obstacle_cloud": enable_local_obstacle_cloud,
